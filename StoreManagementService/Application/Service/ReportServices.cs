...
namespace Application.Services
{
    public class ReportService
    {
        ...
        public ReportService(IWarehouseRepository warehouseRepository, IImportRepos impRepos)
        {
            _impRepos = impRepos;
        ...
        private string GetWarehouseName(int warehouseId)
        {
            ...
            var warehouse = _warehouseRepository.GetByIdAsync(warehouseId).GetAwaiter().GetResult();
